 ...
 */
    ...
    (() => {
            ...
            async function formSubmitAction(form, e) {
                ...
                if (0 === error) {
                    ...
                    if (ajax) {
                        ...
                        form.querySelector("[data-captcha]");
        ...
        function initSliders() {
            if (document.querySelector(".what__swiper")) new core(".what__swiper", {
                ...
                navigation: {
                    prevEl: ".what__button_prev",
                    nextEl: ".what__button_next"
                },
                on: {}
            });
        }
        ...
        const player = document.querySelector(".work__video-ibg");
        const youtubePlay_button = document.querySelector(".work__video-button");
        const url = player.dataset.url;
        const createIframe = () => {
            const iframe = document.createElement("iframe");
            iframe.src = url + "?rel=0&autoplay=1&mute=1";
            iframe.title = "YouTube video player";
            iframe.setAttribute("frameborder", "0");
            iframe.setAttribute("allowfullscreen", "0");
            player.appendChild(iframe);
        };
        youtubePlay_button.addEventListener("click", (() => {
            createIframe();
            youtubePlay_button.style.display = "none";
        }));
        window["FLS"] = true;
        isWebp();
        menuInit();
